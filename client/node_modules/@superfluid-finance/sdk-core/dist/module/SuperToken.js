var _a;
import { ISETH__factory, ISuperToken__factory, } from "@superfluid-finance/ethereum-contracts/build/typechain";
...
export default class SuperToken extends ERC20Token {
    constructor(options, settings) {
        ...
        this.contract = new ethers.Contract(settings.address, ISuperToken__factory.abi);
    }
...
SuperToken.create = async (options) => {
    ...
    try {
        const superToken = ISuperToken__factory.connect(options.address, options.provider);

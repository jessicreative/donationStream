...
export default class BatchCall {
    constructor(options) {
         ...
         */
        this.getCallDataFunctionArgs = (abi, callData) => getTransactionDescription(abi, callData).args;
        /**
        ...
        this.getOperationStruct = async (operation, index) => {
            ...
            if (operation.type === "SUPERFLUID_CALL_AGREEMENT") {
                const functionArgs = this.getCallDataFunctionArgs(Superfluid__factory.abi, populatedTransaction.data);

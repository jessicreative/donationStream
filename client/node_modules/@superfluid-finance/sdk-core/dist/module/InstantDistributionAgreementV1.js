import { IInstantDistributionAgreementV1__factory, } from "@superfluid-finance/ethereum-contracts/build/typechain";
...
export default class InstantDistributionAgreementV1 {
    constructor(hostAddress, idaV1Address) {
        ...
        this.contract = new ethers.Contract(idaV1Address, IInstantDistributionAgreementV1__factory.abi);
    }
}

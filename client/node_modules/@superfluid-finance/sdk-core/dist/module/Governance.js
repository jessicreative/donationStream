import { SuperfluidGovernanceII__factory, } from "@superfluid-finance/ethereum-contracts/build/typechain";
...
export default class Governance {
    constructor(hostAddress, governanceAddress) {
        ...
        this.contract = new ethers.Contract(governanceAddress, SuperfluidGovernanceII__factory.abi);

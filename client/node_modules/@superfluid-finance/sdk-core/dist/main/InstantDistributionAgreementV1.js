...
const idaInterface = typechain_1.IInstantDistributionAgreementV1__factory.createInterface();
/**
...
class InstantDistributionAgreementV1 {
    constructor(hostAddress, idaV1Address) {
        /** ### IDA Read Functions ### */
        /**
        ...
        this.contract = new ethers_1.ethers.Contract(idaV1Address, typechain_1.IInstantDistributionAgreementV1__factory.abi);
    }
}

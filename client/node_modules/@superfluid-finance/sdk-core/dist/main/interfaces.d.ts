import { IConstantFlowAgreementV1, IInstantDistributionAgreementV1, IResolver, Superfluid, SuperfluidGovernanceII } from "@superfluid-finance/ethereum-contracts/build/typechain";
...
export interface ISuperTokenModifyFlowParams extends IShouldUseCallAgreement, EthersParams {
...
export interface IModifyFlowParams extends IShouldUseCallAgreement, EthersParams {
    readonly flowRate?: string;
    readonly receiver: string;
    readonly sender?: string;
    readonly userData?: string;
...
export interface IUpdateFlowOperatorPermissionsParams extends ISuperTokenUpdateFlowOperatorPermissionsParams, IShouldUseCallAgreement {
    readonly superToken: string;
}
export interface IFullControlParams extends ISuperTokenFullControlParams, IShouldUseCallAgreement {
    readonly superToken: string;
}

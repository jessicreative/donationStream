...
class SuperToken extends ERC20Token_1.default {
    constructor(options, settings) {
         ...
         */
        this.send = (params) => {
            const recipient = (0, utils_1.normalizeAddress)(params.recipient);
            const txn = this.contract.populateTransaction.send(recipient, params.amount, params.userData || "0x", params.overrides || {});
            return new Operation_1.default(txn, "ERC777_SEND");
        };
         ...
         */
        this.increaseAllowance = (params) => {
            const spender = (0, utils_1.normalizeAddress)(params.spender);
            const txn = this.contract.populateTransaction.increaseAllowance(spender, params.amount, params.overrides || {});
            return new Operation_1.default(txn, "ERC20_INCREASE_ALLOWANCE");
        };
        /**
         ...
         * @returns {Operation}  An instance of Operation which can be executed or batched.
         */
        this.decreaseAllowance = (params) => {
            const spender = (0, utils_1.normalizeAddress)(params.spender);
            const txn = this.contract.populateTransaction.decreaseAllowance(spender, params.amount, params.overrides || {});
            return new Operation_1.default(txn, "ERC20_DECREASE_ALLOWANCE");
        };
        /** ### CFA Write Functions ### */
        /**
        ...
        this.contract = new ethers_1.ethers.Contract(settings.address, typechain_1.ISuperToken__factory.abi);
    }
...
SuperToken.create = async (options) => {
    ...
    try {
        const superToken = typechain_1.ISuperToken__factory.connect(options.address, options.provider);
...
class NativeAssetSuperToken extends SuperToken {
    ...
    get nativeAssetContract() {
        return new ethers_1.ethers.Contract(this.settings.address, typechain_1.ISETH__factory.abi);
    }
}

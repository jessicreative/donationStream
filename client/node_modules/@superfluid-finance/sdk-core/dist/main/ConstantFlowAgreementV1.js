...
const cfaInterface = typechain_1.IConstantFlowAgreementV1__factory.createInterface();
/**
...
class ConstantFlowAgreementV1 {
    constructor(hostAddress, cfaV1Address, cfaV1ForwarderAddress) {
        ...
        this.contract = new ethers_1.ethers.Contract(cfaV1Address, typechain_1.IConstantFlowAgreementV1__factory.abi);
        this.forwarder = new ethers_1.ethers.Contract(cfaV1ForwarderAddress, typechain_1.CFAv1Forwarder__factory.abi);
    }

...
export interface SuperTokenFactoryStorageLayoutTesterInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "createSuperTokenLogic", values: [PromiseOrValue<string>]): string;
    ...
    decodeFunctionResult(functionFragment: "createSuperTokenLogic", data: BytesLike): Result;
...
export interface SuperTokenFactoryStorageLayoutTester extends BaseContract {
    ...
    functions: {
        ...
        createSuperTokenLogic(arg0: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        createSuperTokenLogic(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
        getCanonicalERC20Wrapper(_underlyingTokenAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
        getCodeAddress(overrides?: CallOverrides): Promise<string>;
        getHost(overrides?: CallOverrides): Promise<string>;
        getSuperTokenLogic(overrides?: CallOverrides): Promise<string>;
